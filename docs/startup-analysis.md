...
| Low conversion free to paid | High | Medium | Make the public page valuable enough to justify paid |
...
Prompt is designed to be deterministic: same commits produce consistent output. Temperature is set low (0.2) to reduce hallucinations.
